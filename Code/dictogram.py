...
class Dictogram(dict):
    ...
    def get_sentence(self, amount=15):
        '''Uses sample by frequency function to gather words and combine them into a single sentence
        self: Dictionary
        amount: int'''
...
def read_file(file):
    '''Grabs words within a file, ignoring characters not A-Z, and converting the words to lowercase'''
